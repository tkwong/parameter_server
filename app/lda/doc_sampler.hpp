...
class DocSampler {
   public:   
    ...
    void sample_one_doc(LDADoc& doc, std::vector<float>& word_topic, std::vector<float>& word_topic_updates, std::map<int, int>& find_start_idx);
